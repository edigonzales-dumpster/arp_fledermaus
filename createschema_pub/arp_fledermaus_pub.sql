...
;
CREATE UNIQUE INDEX T_ILI2DB_MODEL_modelName_iliversion_key ON arp_fledermaus_pub.T_ILI2DB_MODEL (modelName,iliversion)
;
CREATE UNIQUE INDEX T_ILI2DB_ATTRNAME_SqlName_ColOwner_key ON arp_fledermaus_pub.T_ILI2DB_ATTRNAME (SqlName,ColOwner)
;
...
INSERT INTO arp_fledermaus_pub.T_ILI2DB_SETTINGS (tag,setting) VALUES ('ch.interlis.ili2c.ilidirs','%ILI_FROM_DB;%XTF_DIR;http://models.interlis.ch/;%JAR_DIR');
...
INSERT INTO arp_fledermaus_pub.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('SO_ARP_Fledermausfundorte_Publikation_20200806','technicalContact','mailto:agi@bd.so.ch');
