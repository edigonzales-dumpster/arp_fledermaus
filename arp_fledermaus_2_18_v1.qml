...
<qgis version="2.18.16" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="swissbat_link">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="quartierstatus">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{e089b488-2565-439e-b818-74168da14b27}">
      <rule filter="&quot;typ&quot; = 'Quartier' AND  &quot;quartierstatus&quot; IN  ('zerstoert', 'verwaist', 'inaktiv')" key="{e6cd7afb-ced5-475d-84d4-06b2aaab8d33}" symbol="0"/>
      <rule filter="&quot;typ&quot; = 'Quartier' AND &quot;quartierstatus&quot; =   'aktiv' " key="{0f7d93b6-1d9d-4289-b52d-7615c3702d1f}" symbol="1"/>
      <rule filter="&quot;typ&quot; = 'Beobachtung'" key="{544d3f0c-c0e5-4da3-8bc2-250e51a44675}" symbol="2"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,99,71,255"/>
  ...
  <aliases>
    ...
    <alias field="swissbat_link" index="4" name=""/>
    <alias field="quartierstatus" index="5" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <attributeactions default="-1"/>
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="115">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="swissbat_link"/>
      <column width="-1" hidden="0" type="field" name="quartierstatus"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="identifikator" expression=""/>
    <default field="typ" expression=""/>
    <default field="art" expression=""/>
    <default field="swissbat_link" expression=""/>
    <default field="quartierstatus" expression=""/>
  </defaults>
