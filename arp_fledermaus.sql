...
CREATE TABLE arp_fledermaus.fledermausfundrte_fledermausfundort (
  ...
  ,x_lv95 decimal(10,3) NULL
  ,y_lv95 decimal(10,3) NULL
)
;
COMMENT ON TABLE arp_fledermaus.fledermausfundrte_fledermausfundort IS 'Fundorte der Fledermäuse';
COMMENT ON COLUMN arp_fledermaus.fledermausfundrte_fledermausfundort.y_lv95 IS 'Range korrigieren!';
...
;
ALTER TABLE arp_fledermaus.fledermausfundrte_fledermausfundort ADD CONSTRAINT fledrmsfndrt_fldrmsfndort_inaktiv_check CHECK( inaktiv BETWEEN 0 AND 255);
ALTER TABLE arp_fledermaus.fledermausfundrte_fledermausfundort ADD CONSTRAINT fledrmsfndrt_fldrmsfndort_verwaist_check CHECK( verwaist BETWEEN 0 AND 255);
...
ALTER TABLE arp_fledermaus.fledermausfundrte_fledermausfundort ADD CONSTRAINT fledrmsfndrt_fldrmsfndort_y_lv95_check CHECK( y_lv95 BETWEEN 0.0 AND 1400000.0);
...
;
CREATE UNIQUE INDEX T_ILI2DB_MODEL_iliversion_modelName_key ON arp_fledermaus.T_ILI2DB_MODEL (iliversion,modelName)
;
...
!! ########################################################################
','2020-07-28 15:13:32.219');
INSERT INTO arp_fledermaus.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('SO_ARP_Fledermausfundorte_20200728.ili','2.3','SO_ARP_Fledermausfundorte_20200728{ GeometryCHLV95_V1 CHAdminCodes_V1}','INTERLIS 2.3;
...
VERSION "2020-02-27"  =
  ...
  TOPIC Fledermausfundorte =
    ...
    CLASS Fledermausfundort =
      ...
      inaktiv : 0 .. 255;
      verwaist : 0 .. 255;
      x_LV95 : 2400000.000 .. 2800000.000;
      /** Range korrigieren!
       */
      y_LV95 : 0.000 .. 1400000.000;
      UNIQUE quartierid;
...
','2020-07-28 15:13:32.219');
INSERT INTO arp_fledermaus.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('Units-20120220.ili','2.3','Units','!! File Units.ili Release 2012-02-20
...
','2020-07-28 15:13:32.219');
INSERT INTO arp_fledermaus.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('CoordSys-20151124.ili','2.3','CoordSys','!! File CoordSys.ili Release 2015-11-24
...
!! ########################################################################
','2020-07-28 15:13:32.219');
INSERT INTO arp_fledermaus.T_ILI2DB_MODEL (filename,iliversion,modelName,content,importDate) VALUES ('CHBase_Part1_GEOMETRY_20110830.ili','2.3','GeometryCHLV03_V1{ CoordSys Units INTERLIS} GeometryCHLV95_V1{ CoordSys Units INTERLIS}','/* ########################################################################
   CHBASE - BASE MODULES OF THE SWISS FEDERATION FOR MINIMAL GEODATA MODELS
   ======
   BASISMODULE DES BUNDES           MODULES DE BASE DE LA CONFEDERATION
   FÜR MINIMALE GEODATENMODELLE     POUR LES MODELES DE GEODONNEES MINIMAUX
...
INSERT INTO arp_fledermaus.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('DictionariesCH_V1','furtherInformation','http://www.geo.admin.ch/internet/geoportal/de/home/topics/geobasedata/models.html');
INSERT INTO arp_fledermaus.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('DictionariesCH_V1','technicalContact','models@geo.admin.ch');
INSERT INTO arp_fledermaus.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('Dictionaries_V1','furtherInformation','http://www.geo.admin.ch/internet/geoportal/de/home/topics/geobasedata/models.html');
INSERT INTO arp_fledermaus.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('Dictionaries_V1','technicalContact','models@geo.admin.ch');
INSERT INTO arp_fledermaus.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('AdministrativeUnits_V1','furtherInformation','http://www.geo.admin.ch/internet/geoportal/de/home/topics/geobasedata/models.html');
INSERT INTO arp_fledermaus.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('AdministrativeUnits_V1','technicalContact','models@geo.admin.ch');
INSERT INTO arp_fledermaus.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('AdministrativeUnitsCH_V1','furtherInformation','https://www.geo.admin.ch/de/geoinformation-schweiz/geobasisdaten/geodata-models.html');
INSERT INTO arp_fledermaus.T_ILI2DB_META_ATTRS (ilielement,attr_name,attr_value) VALUES ('AdministrativeUnitsCH_V1','technicalContact','mailto:models@geo.admin.ch');
